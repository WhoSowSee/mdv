...
- `--pretty-list` — заменяет стандартные маркеры `-` неупорядоченных списков на иконки Nerd Font для каждого уровня вложенности. Требует шрифт Nerd Font в терминале.
