...
pub(crate) struct ThemeFile {
    ...
    pub math: Option<ColorYaml>,
    pub math_border: Option<ColorYaml>,
    ...
    pub code_block_border: Option<ColorYaml>,
    pub callout_border: Option<ColorYaml>,
    pub horizontal_rule: Option<ColorYaml>,
    pub footnote_separator: Option<ColorYaml>,
    pub front_matter_title: Option<ColorYaml>,
    pub front_matter_key: Option<ColorYaml>,
    pub front_matter_value: Option<ColorYaml>,
    pub front_matter_border: Option<ColorYaml>,
...
impl ThemeFile {
    ...
    pub fn resolve(&self, base: &Theme) -> Theme {
        ...
        Theme {
            ...
            math: pick_optional(&self.math, &base.math),
            math_border: pick_optional(&self.math_border, &base.math_border),
            ...
            code_block_border: pick_optional(&self.code_block_border, &base.code_block_border),
            callout_border: pick_optional(&self.callout_border, &base.callout_border),
            horizontal_rule: pick_optional(&self.horizontal_rule, &base.horizontal_rule),
            footnote_separator: pick_optional(&self.footnote_separator, &base.footnote_separator),
            ...
            front_matter_border: pick_optional(
                &self.front_matter_border,
                &base.front_matter_border,
            ),
            inline_style,
            ...
            table_border_overridden: self.table_border.is_some() || base.table_border_overridden,
    ...
    fn into_complete(mut self) -> Result<Theme> {
        ...
        Ok(Theme {
            ...
            math: Some(color!(self, math)),
            math_border: Some(color!(self, math_border)),
            ...
            code_block_border: self.code_block_border.take().map(|value| value.0),
            callout_border: self.callout_border.take().map(|value| value.0),
            horizontal_rule: self.horizontal_rule.take().map(|value| value.0),
            footnote_separator: self.footnote_separator.take().map(|value| value.0),
