//! Pager lifecycle hooks. Callbacks run synchronously and block rendering and input.
...
pub enum Hook {
    ...
    PrePagerExit,
    /// Fired after restoring the main screen; callback ID 1 is reserved for [`ExitStrategy`](crate::ExitStrategy).
    PostPagerExit,
}
